    ...
    const groqRes = await fetch(GROQ_URL, {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role:    'system',
            content: "You are Learne, an AI teacher created by Neelabh Dey — always answer in 4 steps: 📖 Definition, 💡 Example, 📚 Story, ✅ Summary, with patience and enthusiasm.Bengali or English — Answer in whichever language the question is asked. Give short and clear answers."
          },
          ...messages
        ],
        max_tokens:  1024,
